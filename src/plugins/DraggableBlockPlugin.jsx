...
import { isHTMLElement } from "../LexicalUtils/guard";
import { Point } from "../LexicalUtils/point";
import { Rect } from "../LexicalUtils/rect";
...
function setDragImage(dataTransfer, draggableBlockElem) {
  const transform = draggableBlockElem.style.transform;
