...
export function $createMeetingDetailsNode(meetingDetails, formattingOptions) {
  ...
  // Apply formatting options if present
  if (formattingOptions === "center") {
    setElementProperties(h1Node, { textAlign: "center" });
  }
